...
(2) `adata_processed.h5ad`: this is processed `adata` object from running `01_preprocessing.ipynb` (the file is generated and saved within the notebook). This object is used in downstream ML models and contains representations, HVG expressions.